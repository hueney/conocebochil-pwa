  ...
  <section class="section about">
    <article class="text-center container">
          <aside class="text-center logoacerca ">
              ...
              <p>
                Somos una aplicación web, donde podras ofrecer tus productos y servicios de forma digital, subir fotografías y crear tu propio catalogo virtual para estar más cerca de tus clientes.
              </p>
